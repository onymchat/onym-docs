...
| [Discovery](seats/discovery.md) | [Static Snapshot / Ed25519](seats/discovery-static-ed25519.md): five GitHub release assets across three repos (operational) + [`onym-discovery`](https://github.com/onymchat/onym-discovery) reference CLI for the signed-catalog profile | `releases/latest/download/*` (what clients read), `discovery.onym.app` (signed catalog) |
